...
class ApppppCL: Application() {
    companion object {
        const val AF_DEV_KEY = "8FYEGvXpSQkC6yoqZy4PLS"
        const val jsoupCheck = "1v5b"
        const val ONESIGNAL_APP_ID = "5222632a-75bf-4d8b-b7f3-5b16bb9552c1"

        val linkAppsCheckPart1 = "http://wondrous"
        val linkAppsCheckPart2 = "palladium.xyz/apps.txt"
