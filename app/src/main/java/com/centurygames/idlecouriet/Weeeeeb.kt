...
import com.centurygames.idlecouriet.ApppppCL.Companion.MAIN_ID
import com.centurygames.idlecouriet.databinding.ActivityWeeeeebBinding
...
class Weeeeeb : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeeeebBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeeeebBinding.inflate(layoutInflater)
